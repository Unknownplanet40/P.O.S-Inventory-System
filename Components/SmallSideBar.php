...
<main class="d-flex flex-nowrap" style="overflow-x: hidden;">
    <div class="d-flex flex-column flex-shrink-0 bg-body-tertiary" style="height: 100vh; width: 4.5rem;">
        <a href="/" class="d-block p-3 link-body-emphasis text-decoration-none" title="Manlalaba Laundry Station"
        ...
        <div class="dropdown border-top" hidden title="Settings / Can't Open Dropdown Here" data-bs-toggle="tooltip" data-bs-placement="right">
            <a href="#"
